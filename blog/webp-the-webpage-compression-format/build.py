...
s = before + f"""<noscript><meta http-equiv=refresh content=0;url=nojs.html></noscript><div style=height:100000px><script type=module>let c=new OffscreenCanvas({width},{height}).getContext("webgl"),t=c.createTexture(),p=new Uint8Array({width * height * 4}),y=new Uint8Array({len(html.encode())}),i=0
...
document.documentElement.innerHTML=new TextDecoder().decode(y)
</script>"""
