...
Or is it? Here's a trick [Yuki](https://codeberg.org/sylfn/) invented. We can map `__` to `u16::MAX`, but also replace `n << 4` with `n.rotate_left(4)` and addition with bitwise OR:
